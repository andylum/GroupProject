...
% haven't actually decided on a finalized name yet, so using this as a placeholder name.
\newcommand\projname{Vapor}

\title{\projname, A PC Game Library Manager\\ UTM CSCI 352 Group Project}
%
%
...
\begin{abstract}
\projname{} will be a minamalist game library manager to help gamers keep track of all of their games across various launchers. This proposal document is the bulk of what we've done so far.
\end{abstract}
...
That's where \projname{} comes in. \projname{} will allow for a user to keep up with every game they have on their computer with minimal upkeep on their end.
